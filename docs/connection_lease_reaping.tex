...
2) even before any \texttt{Depart} for \texttt{c?} occurs. The coverage
audit, \texttt{docs/connection\_lease\_reaping\_coverage.md}, carries
forward, unresolved, the design gap round 1 already surfaced: a
