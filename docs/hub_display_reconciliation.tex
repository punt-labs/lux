...
fd, and one unrelated \texttt{kind="direct"} connection that must be
...
\begin{description}
  ...
  \item[P3 --- a \texttt{kind="direct"} identify never preempts.] Covered:
    \texttt{test\_a\_direct\_identify\_never\_preempts\_or\_marks\_hub},
