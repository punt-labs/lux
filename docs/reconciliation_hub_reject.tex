...
% commit_on_idle_reconciliation.tex -- the general spec that models the honour /
% defer / commit-echo discipline shared by every continuous-edit element over a
% data-independent carrier [VALUE] that is IMPLICITLY the set of Hub-accepted
