...
starting with refactoring the already-shipped basics and inputs families onto
it (PRs 3 and 4 of this revision), then bringing the remaining element families
onto the same shape from the start (PRs 5–7), and finally cleanup and process
split (PRs 8 and 9).
