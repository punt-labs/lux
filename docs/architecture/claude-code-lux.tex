...
This is a formal integration specification, not the canonical rewrite-target
document. For the rewrite target, start with \texttt{target/target.md}. For
the current/intermediate whole-system narrative, see \texttt{system.tex}.
