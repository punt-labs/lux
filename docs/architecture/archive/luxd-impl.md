# Archived: Lux MCP Proxy Architecture (v2)

> Archived implementation-planning document. This is not a primary
> architecture source. Use [target/target.md](../target/target.md) and
> [target/topology.md](../target/topology.md) for the target model, and
> [../system.tex](../system.tex) for the current/intermediate system view.
