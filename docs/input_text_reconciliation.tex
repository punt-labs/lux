...
% input_text holds, the float a slider holds, or the arity-4 RGBA float tuple a
% color_picker holds -- so it governs ALL THREE arbiters unchanged.  The tuple
...
%          encoding; the float carrier's by SliderElement.validate.
