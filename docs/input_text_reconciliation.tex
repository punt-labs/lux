...
%   src/punt_lux/display/renderers/imgui/color_picker_selection.py
%       -- ColorPickerArbiter: the RGBA-tuple sibling of InputTextArbiter, same
%          resolve/observe/commit/release honour-or-defer control flow; the
%          carrier is an arity-4 tuple whose finiteness precondition is
%          discharged structurally by the hex encoding
...
%       -- WidgetState: the per-scene buffer/editing slots (input, slider, and
%          color triples/quad) and their removal clear (discard_for)
%
