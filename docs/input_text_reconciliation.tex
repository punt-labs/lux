...
% input_text holds, the float a slider or an input_number holds, or the arity-4
% RGBA float tuple a color_picker holds -- so it governs ALL FOUR arbiters
% unchanged.  The input_number reuses the slider's float carrier verbatim (the
