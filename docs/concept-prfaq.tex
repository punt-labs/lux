...
\addbibresource{concept-prfaq.bib}
...
\begin{center}
  \fbox{\parbox{0.9\textwidth}{\centering\small\textcolor{AccentGray}{%
    \textbf{Concept Stage.} This PR/FAQ explores a product direction for Lux
    as a self-extending display server. It is not a committed roadmap.
    The ideas here may inform future work. See also:
