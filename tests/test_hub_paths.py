"""Tests for hub path functions in punt_lux.hub_paths."""
...
from punt_lux.hub_paths import (
    hub_dir,
    hub_log_dir,
    hub_pid_path,
    hub_port_path,
...
class TestReadHubPort:
    def test_returns_none_when_missing(self, tmp_path: Path):
        ...
        with patch(
            "punt_lux.hub_paths.hub_port_path", return_value=fake_dir / "hub.port"
        ):
    ...
    def test_reads_valid_port(self, tmp_path: Path):
        ...
        with patch("punt_lux.hub_paths.hub_port_path", return_value=port_file):
...
class TestIsHubRunning:
    def test_returns_false_when_no_pid(self, tmp_path: Path):
        ...
        with patch("punt_lux.hub_paths.hub_pid_path", return_value=pid_file):
