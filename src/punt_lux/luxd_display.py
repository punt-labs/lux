...
serve`` (``punt_lux.cli.display``) delegates to :func:`serve` below for
interactive/manual use; the two entry points share one implementation.
...
def main() -> None:
    ...
    serve(args.socket, test_auto_click=args.test_auto_click)
