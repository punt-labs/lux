...
families. Every interaction-event class (``ButtonClicked``, ``TabChanged``,
``RowSelectionChanged``, ...) satisfies it implicitly — the Protocol carries no
required members, only an identity. The events that also cross the wire answer
to the richer ``WireEvent`` beside it.
