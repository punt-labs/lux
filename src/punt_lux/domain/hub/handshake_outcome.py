"""What ``HandshakeConnector.dial`` produces: a result, or a failure.
...
Bundling both under the handshake's own vocabulary keeps its callers importing
one module for what a connect attempt can produce, rather than two.
"""
...
class HandshakeResult:
    ...
    sock: socket.socket
    endpoint: str  # log label: socket path, or host:port cross-host; never re-dialed
    ready: ReadyMessage
