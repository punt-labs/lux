...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/d2b1e57/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/d2b1e57/install.sh -o install.sh
