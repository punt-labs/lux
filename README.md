...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/c7085bd/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/c7085bd/install.sh -o install.sh
