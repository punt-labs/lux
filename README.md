...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/5c46508/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/5c46508/install.sh -o install.sh
