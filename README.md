...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/e6803ba/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/e6803ba/install.sh -o install.sh
