...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/ab155d9/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/ab155d9/install.sh -o install.sh
