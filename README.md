...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/f803d67/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/f803d67/install.sh -o install.sh
