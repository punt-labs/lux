...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/0abada3/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/0abada3/install.sh -o install.sh
