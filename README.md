...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/fb3d481/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/fb3d481/install.sh -o install.sh
