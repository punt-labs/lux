...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/d2eb78c/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/d2eb78c/install.sh -o install.sh
