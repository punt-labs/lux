...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/b213ee45/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/b213ee45/install.sh -o install.sh
