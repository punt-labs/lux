...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/627a97d8/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/627a97d8/install.sh -o install.sh
