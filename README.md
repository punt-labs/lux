...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/64ac5ec/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/64ac5ec/install.sh -o install.sh
