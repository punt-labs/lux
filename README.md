...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/79ff0daf/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/lux/79ff0daf/install.sh -o install.sh
